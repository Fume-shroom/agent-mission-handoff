...
`)
	got, err := NativeFork("codex", raw, "new", "/new", "continue mission", "target-provider")
	if err != nil {
		t.Fatal(err)
	}
...
`)
	got, err := NativeFork("claude", raw, "22222222-2222-4222-8222-222222222222", "/new", "continue mission", "")
	if err != nil {
		t.Fatal(err)
	}
